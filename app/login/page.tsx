    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-border shadow-lg">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">Zambia School Pro</CardTitle>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="h-auto p-0 text-xs text-emerald-600" type="button">
                  Forgot password?
                </Button>
              </div>
              <div className="relative">
        ...
        <CardFooter className="flex justify-center border-t border-border pt-6">
          <p className="text-xs text-muted-foreground">Professional Grade Results Management for Zambian Schools</p>
        </CardFooter>
      </Card>
    </div>
  )
